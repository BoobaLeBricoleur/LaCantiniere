 ...
 * Status exception.
 */
public class InconsistentRoleException extends AbstractFunctionalException {
	@Serial
	 ...
	 * {@link #initCause}.
	 */
	public InconsistentRoleException() {
		super();
	}
	 ...
	 */
	public InconsistentRoleException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	public InconsistentRoleException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	public InconsistentRoleException(String pMessage, Throwable pCause) {
