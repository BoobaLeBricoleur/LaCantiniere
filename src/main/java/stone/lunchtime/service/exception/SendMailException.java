 ...
 * Send mail exception.
 */
public class SendMailException extends AbstractFunctionalException {
	@Serial
	 ...
	 */
	public SendMailException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	public SendMailException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	public SendMailException(String pMessage, Throwable pCause) {
