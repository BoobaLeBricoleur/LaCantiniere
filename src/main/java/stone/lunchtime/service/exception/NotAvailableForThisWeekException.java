...
/**
 * Exception when entity is not available
 */
public class NotAvailableForThisWeekException extends AbstractFunctionalException {
	@Serial
	 ...
	 * {@link #initCause}.
	 */
	public NotAvailableForThisWeekException() {
		super();
	}
	 ...
	 */
	public NotAvailableForThisWeekException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	public NotAvailableForThisWeekException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	public NotAvailableForThisWeekException(String pMessage, Throwable pCause) {
