 ...
 * Password exception.
 */
public class InconsistentPasswordException extends AbstractFunctionalException {
	@Serial
	 ...
	 */
	public InconsistentPasswordException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	public InconsistentPasswordException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	public InconsistentPasswordException(String pMessage, Throwable pCause) {
