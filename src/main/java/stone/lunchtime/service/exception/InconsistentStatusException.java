 ...
 * Status exception.
 */
public class InconsistentStatusException extends AbstractFunctionalException {
	@Serial
	 ...
	 */
	public InconsistentStatusException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	public InconsistentStatusException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	public InconsistentStatusException(String pMessage, Throwable pCause) {
