...
/**
 * Exception when user has not enough money.
 */
public class LackOfMoneyException extends AbstractFunctionalException {
	@Serial
	 ...
	 */
	public LackOfMoneyException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	public LackOfMoneyException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	public LackOfMoneyException(String pMessage, Throwable pCause) {
