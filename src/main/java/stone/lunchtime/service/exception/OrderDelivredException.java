 ...
 * Status exception
 */
public class OrderDelivredException extends AbstractFunctionalException {
	@Serial
	 ...
	 */
	public OrderDelivredException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	public OrderDelivredException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	public OrderDelivredException(String pMessage, Throwable pCause) {
