...
/**
 * Mother of all functional exception.
 */
public abstract class AbstractFunctionalException extends Exception {
	 ...
	 * {@link #initCause}.
	 */
	protected AbstractFunctionalException() {
		super();
	}
	 ...
	 */
	protected AbstractFunctionalException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	protected AbstractFunctionalException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	protected AbstractFunctionalException(String pMessage, Throwable pCause) {
